...
useEffect(() => {
  ...
  return <div style={{backgroundColor:'#f2f2f2',margin:'0px',border:'1px solid #f2f2f2',padding:'10px'}}><div style={{width:'1200px',margin:'0px auto',backgroundColor:'white',borderRadius:'8px',padding:'25px'}}> <div>
  ...
  el.type === "text" ? (
    ...
    >
     ...
     {el.el.map((val) => {
          const found = store.products.find((x) => x.id === parseInt(val));
          return (
            <div>
              <img
                style={{
